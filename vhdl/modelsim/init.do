...
vcom -2002 -explicit {../subsystems/sdram/Header Creator/header_creator.vhd}
...
vcom -2002 -explicit ../subsystems/sdram/tests/header_creator_tb.vhd

vsim -gui work.header_creator_tb
...
# add wave -position end sim:/imaging_buffer_tb/imaging_buffer/row_encoder_inst/*
